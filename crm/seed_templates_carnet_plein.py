"""crm.seed_templates_carnet_plein : 15 templates email Carnet Plein®
   ...
   Ce script SUPPRIME tous les templates existants avant insert (--reset par défaut).
   ...
   Tous les templates intègrent l'offre fondateur :
     ...
     . Founder's case Mad Makers (chiffres mesurés en interne, publiés plus tard)
   ...
   Aucun tiret cadratin "—" dans aucun template (interdiction durable).
...
J0_PILOTE_EXPLICATION = {
    "name":        "Carnet Plein · J0 · Vague Pilote (principal)",
    "description": "Premier contact, angle direct lettre du fondateur, offre fondateur transparente",
    "category":    "cold_email",
    "segment":     SEG,
    "step":        "J0",
    "subject":     "Une offre fondateur pour 5 chauffagistes RGE",
    "body_html":   H(
        "Bonjour {{prenom}},\n\n"
...
J0_CARNET = {
    ...
    "description": "Premier contact, angle saisonnalité et carnet en dents-de-scie",
    "category":    "cold_email",
    "segment":     SEG,
    "step":        "J0",
    ...
    "body_html":   H(
        ...
        "Nous on fournit un système d'acquisition de chantiers clés en main aux artisans RGE en {{ville}} et région. Site (refonte ou création selon votre situation), Google, avis, reporting, cohort coaching.\n\n"
...
J0_GBP = {
    ...
    "description": "Premier contact, angle Local Pack et SEO local",
    "category":    "cold_email",
    "segment":     SEG,
    "step":        "J0",
    ...
    "body_html":   H(
        ...
        "3. Pages géolocalisées (1 page = 1 commune, dans votre site ou un site qu'on créera selon votre situation)\n\n"
...
J4_TRANSPARENCE_CHIFFRES = {
    "name":        "Carnet Plein · J+4 · Transparence sur la méthode",
    "description": "Relance, partage la mécanique exacte (4 leviers) avec transparence",
    "category":    "follow_up",
    "segment":     SEG,
    "step":        "J+4",
    "subject":     "Re: {{entreprise}}, exactement ce qu'on ferait",
    "body_html":   H(
        "{{prenom}},\n\n"
        "Petit suivi. Vous vous demandez peut-être : « OK c'est joli sur le papier, mais concrètement vous feriez quoi pour {{entreprise}} ? »\n\n"
        "Concrètement, sur 12 mois :\n\n"
        "<strong>Mois 1 (setup) :</strong>\n"
        "1. Audit complet de votre présence actuelle (site, GBP, avis, SEO local)\n"
        "2. Refonte ou création site selon votre situation (3 à 5 pages, optimisé conversion locale)\n"
        "3. Fiche Google Business Profile à 100 % (catégories, services, FAQ, photos hebdo programmées)\n"
        "4. Setup automatisation SMS post-chantier pour avis Google\n\n"
        "<strong>Mois 2 à 12 (acquisition) :</strong>\n"
        "1. Campagne d'acquisition ciblée (Google Ads chaudière/PAC + retargeting)\n"
        "2. Contenu hyper-local (1 page par commune cible, vous nous donnez 5 communes)\n"
        "3. Reporting mensuel (leads, conversions, coût par lead, projection ROI)\n"
        "4. Coaching cohort (1 visio par mois avec les autres artisans de la Vague Pilote)\n\n"
        "Pour les 5 artisans de la Vague Pilote : <strong>4 500 € HT sur 12 mois, garantie 80 % KPI</strong>.\n\n"
        "Si la mécanique vous parle, 20 minutes en visio, sans engagement : <a href=\"{{calendly}}\" style=\"color:#0066cc;\">{{calendly}}</a>"
    ),
}

J4_PDF_BONUS = {
    "name":        "Carnet Plein · J+4 · Envoi PDF checklist",
    "description": "Relance, envoie une checklist utile en valeur pure (réciprocité Cialdini)",
    "category":    "follow_up",
    "segment":     SEG,
    "step":        "J+4",
    ...
    "body_html":   H(
        ...
        "Si après lecture vous voulez qu'on regarde ensemble votre situation comme cas concret, j'ai 20 min pour vous. La <strong>Vague Pilote 2026</strong> est encore ouverte (5 places à 1 500 € + 250 €/mois, garantie 80 % KPI).\n\n"
...
J10_COHORT = {
    ...
    "body_html":   H(
        ...
        "Une fois les 5 places fermées, on bascule sur tarif standard et on rouvre une vague seulement après avoir publié les 5 études de cas (probablement Q3 ou Q4 2026).\n\n"
...
J10_PRIX = {
    ...
    "body_html":   H(
        ...
        "• Hellio ou Effy commissionneurs : 10 à 20 % de marge en moins par chantier MaPrimeRénov'\n\n"
...
KICKOFF_J7 = {
    ...
    "body_html":   H(
        ...
        "• Tarif moyen ou marge moyenne par chantier (pour calibrer l'objectif KPI)\n"
        "• 5 à 10 photos de chantiers récents (PAC, chaudière, sanitaire, en haute déf)\n"
...
ALL_TEMPLATES = [
    ...
    J4_QUESTION_DIRECTE, J4_TRANSPARENCE_CHIFFRES, J4_PDF_BONUS,
...
def main():
    ...
    parser.add_argument("--yes", action="store_true",
                        help="Skip le prompt de confirmation (utile en CI ou script)")
